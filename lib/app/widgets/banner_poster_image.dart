...
//   void initState() {
//     super.initState();
//     _posterHelper = PosterHelper(getBannerPosterService()); // Pass the service instance
//     _loadPosterImage();
//     _loadBannerImage();
//   }

//   Future<void> _loadPosterImage() async {
//     final imageUrl = await _posterHelper.getPosterImage(
...
//     final imageUrl = await _posterHelper.getBannerImage(
//       mediaType: widget.mediaType,
//       mediaId: widget.mediaId,
//     );
