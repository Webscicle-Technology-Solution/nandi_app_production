...
class HomePageState extends ConsumerState<HomePage> {
  ...
  final Map<String, GlobalKey> _sectionKeys = {};
  final Map<String, List<FocusNode>> _focusNodes = {};
  final FocusNode _featuredFocusNode = FocusNode(debugLabel: 'featuredsection_main');
  int _currentSectionIndex = 0;
  int _currentItemIndex = 0;
  bool _isTV = false;
  bool _isInitialized = false;
  ...
  Widget _buildContinueWatchingSection(String selectedFilter, AsyncValue<User?> userAsyncValue) {
  ...
  Widget _buildLoadingContinueWatching() {
    return Column(
      ...
      children: [
        Padding(
          padding: const EdgeInsets.only(top: 5.0, left: 5.0, bottom: 5),
          child: Text('Continue Watching', style: TextStyle(fontWeight: FontWeight.bold)),
        ),
        SingleChildScrollView(
          scrollDirection: Axis.horizontal,
          child: Padding(
  ...
  Widget _buildContinueWatchingContent(AsyncValue<List<WatchHistoryItem>> filteredContinueWatchingAsync) {
