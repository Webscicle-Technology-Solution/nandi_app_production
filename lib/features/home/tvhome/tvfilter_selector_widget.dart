...
class _PrimeFilterBarState extends ConsumerState<PrimeFilterBar> with SingleTickerProviderStateMixin {
    ...
    return visibleContentTypesAsync.when(
      data: (contentTypes) {
        ...
        while (_filterFocusNodes.length < displayNames.length) {
          _filterFocusNodes.add(FocusNode(debugLabel: 'filter_${_filterFocusNodes.length}'));
        }
