...
import 'package:nandiott_flutter/app/widgets/downloadbutton.dart';
...
import 'package:nandiott_flutter/features/videoPlayer/videoplayer.dart';
...
class _MovieDetailPageState extends ConsumerState<MovieDetailPage> {
  ...
  void _resetRating() {
    setState(() {
      currentRating = 0.0;
      print("current rating in reset rating is ${currentRating}");
    });
  }
...
void _handleEpisodeTap(
  ...
  //                 loading: () => const ListTile(title: Text("Loading user...")),
  //                 error: (err, _) =>
  //                     const ListTile(title: Text("Error loading user")),
  //                 data: (user) {
  //                   final isLoggedIn = user != null;
  //                   final subscriptionAsync = isLoggedIn
  //                       ? ref.watch(subscriptionProvider(
  ...
  //                                         content: const Text(
  //                                             "Please subscribe to watch this episode."),
  //                                         actions: [
  //                                           TextButton(
  //                                             onPressed: () =>
  //                                                 Navigator.pop(context),
