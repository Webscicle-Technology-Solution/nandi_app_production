...
class _TVSearchPageState extends ConsumerState<TVSearchPage> {
  ...
  void _requestSideMenuFocus() {
    // This method should be implemented to request focus on your side menu
    // For example, if you have a FocusNode for your side menu:
    // sideMenuFocusNode.requestFocus();

    // You'll need to pass this focus request to your parent widget
    // or use a global focus handling system
    print("Request to focus side menu - implement this method");
  }
  ...
  Widget build(BuildContext context) {
    ...
    final currentSection = ref.watch(currentSearchSectionProvider);
                                ...
                                if (event is RawKeyDownEvent) {
                                  ...
                                  if (event.logicalKey ==
                                    ...
                                    if (index > 0) {
                                      ...
                                      // For issue #2: Handle navigation to side menu
                                      // This assumes you have a method to request focus on your side menu
                                      // You'll need to implement this according to your side menu structure
                                      _requestSideMenuFocus();
                                      return KeyEventResult.handled;
                                    }
...
// Custom TV-optimized film card
// class TVFilmCard extends StatelessWidget {
//   final dynamic film;
//   final bool hasFocus;
...
//               // Title
//               Container(
//                 color: hasFocus ? Colors.amber : Colors.black,
//                 padding: EdgeInsets.all(8),
//                 width: double.infinity,
//                 child: Text(
//                   film.title ?? film.name ?? 'Unknown',
//                   style: TextStyle(
...
void _navigateToMovieDetails(
  ...
  print("Navigate to details for: ${movie.title}");
  // Example:
...
//               child: Image.network(
//                 film.id ?? 'https://via.placeholder.com/150',
//                 fit: BoxFit.cover,
//                 width: double.infinity,
//               ),
//             ),
